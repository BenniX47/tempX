...
\definecolor{darkgreen}{CMYK}{0,0,.6}
<<<<<<< HEAD:Pflichtenheft.tex
\hypersetup{pdftex=false, colorlinks=true, breaklinks=true, linkcolor=darkgreen, menucolor=darkblue, pagecolor=darkblue, urlcolor=darkblue, citecolor=darkblue}
=======
